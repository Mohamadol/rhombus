...
// mat * (vec0 + vec1), mat is of dimension 'nr * nc'
void MatVecMul(uint32_t nr, uint32_t nc, uint64_t *mat, uint64_t *vec, uint64_t *mv, bool is_transpose)
{
    chrono::high_resolution_clock::time_point time_start, time_end;
    chrono::microseconds time_diff;

    cout << "+----------- MatVecMul Rhombus -----------+" << endl;
    if (party == 1){
        time_start = chrono::high_resolution_clock::now();
        uint64_t before_sent = rhombus_linear->IO()->counter;

        uint64_t *mat_copy = new uint64_t[nr * nc];
        if (is_transpose){ // transpose
            for (size_t i = 0; i < nr; ++i){
                for (size_t j = 0; j < nc; ++j){
                    mat_copy[i * nc + j] = mat[j * nr + i];
                }
            }
        }else{
            std::copy_n(mat, nr * nc, mat_copy);
        }

        rhombus_linear->MatVecMul(nr, nc, mat_copy, vec, mv);
        ...
        MatMulTimeInMilliSec_Rhombus += uint64_t(time_diff.count() / 1000.);
        MatMulCommSent_Rhombus += (rhombus_linear->IO()->counter - before_sent);
        cout << "Time: " << time_diff.count() / 1000. << " ms" << endl;
        cout << "Sent: " << (rhombus_linear->IO()->counter - before_sent) / 1024. / 1024. << " MB" << endl;
    } else{
        time_start = chrono::high_resolution_clock::now();
        uint64_t before_sent = rhombus_linear->IO()->counter;

        rhombus_linear->MatVecMul(nr, nc, nullptr, vec, mv);
...
void FusedBN_1m1Filter(int32_t N, int32_t H, int32_t W, int32_t CI, int32_t fh,
             int32_t fw, int32_t CO, int32_t padHLeft, int32_t padHRight,
             int32_t padWLeft, int32_t padWRight, int32_t strideH,
             int32_t strideW, uint64_t *in_tensor, 
             const uint64_t *filters,
  ...
  Conv2DWrapper_1m1Filter(H, W, CI, CO, strideH, in_tensor, scaled_filters, out_tensor);
  // Conv2DWrapper(N, H, W, CI, fh, fw, CO, padHLeft, padHRight, padWLeft, padWRight, strideH, strideW, in_tensor, scaled_filters, out_tensor);
...
int main(int argc, char **argv) {
  ...
  // conv #2 use Rhombus
  Conv2DWrapper_1m1Filter(56, 56, 64, 256, 1, tmp265, tmp6, tmp267);
  ...
  // conv #3
  FusedBN_1m1Filter(1, 56, 56, 64, 1, 1, 64, 0, 0, 0, 0, 1, 1, tmp265, tmp7, tmp8, tmp9, tmp272);
#else
  // Cheetah
...
#ifdef USE_RHOMBUS
  // conv #5 : use Rhombus
  Conv2DWrapper_1m1Filter(56, 56, 64, 256, 1, tmp285, tmp17, tmp287);
...
#ifdef USE_RHOMBUS
  // conv #6
  FusedBN_1m1Filter(1, 56, 56, 256, 1, 1, 64, 0, 0, 0, 0, 1, 1, tmp296, tmp22, tmp23,
          tmp24, tmp301);
#else
...
#ifdef USE_RHOMBUS
  // conv #8
  Conv2DWrapper_1m1Filter(56, 56, 64, 256, 1, tmp314, tmp32, tmp316);
#else
...
#ifdef USE_RHOMBUS
  // conv #9
  FusedBN_1m1Filter(1, 56, 56, 256, 1, 1, 64, 0, 0, 0, 0, 1, 1, tmp325, tmp37, tmp38,
          tmp39, tmp330);
#else
...
#ifdef USE_RHOMBUS
  // conv #11
  Conv2DWrapper_1m1Filter(56, 56, 64, 256, 1, tmp343, tmp47, tmp345);
#else
...
#ifdef USE_RHOMBUS
  // conv #12
  Conv2DWrapper_1m1Filter(56, 56, 256, 512, 2, tmp358, tmp52, tmp360);
#else
...
#ifdef USE_RHOMBUS
  // conv #13
  FusedBN_1m1Filter(1, 56, 56, 256, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp355, tmp53, tmp54,
          tmp55, tmp366);
#else
...
#ifdef USE_RHOMBUS
  // conv #15
  Conv2DWrapper_1m1Filter(28, 28, 128, 512, 1, tmp383, tmp63, tmp385);
#else
...
#ifdef USE_RHOMBUS
  // conv #16
  FusedBN_1m1Filter(1, 28, 28, 512, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp394, tmp68, tmp69,
          tmp70, tmp399);
#else
...
#ifdef USE_RHOMBUS
  // conv #18
  Conv2DWrapper_1m1Filter(28, 28, 128, 512, 1, tmp412, tmp78, tmp414);
...
#ifdef USE_RHOMBUS
  // conv #19
  FusedBN_1m1Filter(1, 28, 28, 512, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp423, tmp83, tmp84,
          tmp85, tmp428);
#else
...
#ifdef USE_RHOMBUS
  // conv #21
  Conv2DWrapper_1m1Filter(28, 28, 128, 512, 1, tmp441, tmp93, tmp443);
#else
...
#ifdef USE_RHOMBUS
  // conv #22
  FusedBN_1m1Filter(1, 28, 28, 512, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp452, tmp98, tmp99,
          tmp100, tmp457);
#else
...
#ifdef USE_RHOMBUS
  // conv #24
  Conv2DWrapper_1m1Filter(28, 28, 128, 512, 1, tmp470, tmp108, tmp472);
#else
...
#ifdef USE_RHOMBUS
  // conv #25
  Conv2DWrapper_1m1Filter(28, 28, 512, 1024, 2, tmp485, tmp113, tmp487);
#else
...
#ifdef USE_RHOMBUS
  // conv #26
  FusedBN_1m1Filter(1, 28, 28, 512, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp482, tmp114, tmp115,
          tmp116, tmp493);
#else
...
#ifdef USE_RHOMBUS
  // conv #28
  Conv2DWrapper_1m1Filter(14, 14, 256, 1024, 1, tmp510, tmp124, tmp512);
#else  
...
#ifdef USE_RHOMBUS
  // conv #29
  FusedBN_1m1Filter(1, 14, 14, 1024, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp521, tmp129, tmp130,
          tmp131, tmp526);
#else
...
#ifdef USE_RHOMBUS
  // conv #31
  Conv2DWrapper_1m1Filter(14, 14, 256, 1024, 1, tmp539, tmp139, tmp541);
#else
...
#ifdef USE_RHOMBUS
  // conv #32
  FusedBN_1m1Filter(1, 14, 14, 1024, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp550, tmp144, tmp145,
          tmp146, tmp555);
#else
...
#ifdef USE_RHOMBUS
  // conv #34
  Conv2DWrapper_1m1Filter(14, 14, 256, 1024, 1, tmp568, tmp154, tmp570);
#else
...
#ifdef USE_RHOMBUS
  // conv #35
  FusedBN_1m1Filter(1, 14, 14, 1024, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp579, tmp159, tmp160,
          tmp161, tmp584);
#else
...
#ifdef USE_RHOMBUS
  // conv #37
  Conv2DWrapper_1m1Filter(14, 14, 256, 1024, 1, tmp597, tmp169, tmp599);
#else
...
#ifdef USE_RHOMBUS
  // conv #38
  FusedBN_1m1Filter(1, 14, 14, 1024, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp608, tmp174, tmp175,
          tmp176, tmp613);
#else
...
#ifdef USE_RHOMBUS
  // conv #40
  Conv2DWrapper_1m1Filter(14, 14, 256, 1024, 1, tmp626, tmp184, tmp628);
#else
...
#if USE_RHOMBUS
  // conv #41
  FusedBN_1m1Filter(1, 14, 14, 1024, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp637, tmp189, tmp190,
          tmp191, tmp642);
#else
...
#ifdef USE_RHOMBUS
  // conv #43
  Conv2DWrapper_1m1Filter(14, 14, 256, 1024, 1, tmp655, tmp199, tmp657);
#else
...
#ifdef USE_RHOMBUS
  // conv #44
  Conv2DWrapper_1m1Filter(14, 14, 1024, 2048, 2, tmp670, tmp204, tmp672);
#else
...
#ifdef USE_RHOMBUS
  // conv #45
  FusedBN_1m1Filter(1, 14, 14, 1024, 1, 1, 512, 0, 0, 0, 0, 1, 1, tmp667, tmp205, tmp206,
          tmp207, tmp678);
#else
...
#ifdef USE_RHOMBUS
  // conv #47
  Conv2DWrapper_1m1Filter(7, 7, 512, 2048, 1, tmp695, tmp215, tmp697);
#else
...
#ifdef USE_RHOMBUS
  // conv #48
  FusedBN_1m1Filter(1, 7, 7, 2048, 1, 1, 512, 0, 0, 0, 0, 1, 1, tmp706, tmp220, tmp221,
          tmp222, tmp711);
#else
...
#ifdef USE_RHOMBUS
  // conv #50
  Conv2DWrapper_1m1Filter(7, 7, 512, 2048, 1, tmp724, tmp230, tmp726);
#else
...
#ifdef USE_RHOMBUS
  // conv #51
  FusedBN_1m1Filter(1, 7, 7, 2048, 1, 1, 512, 0, 0, 0, 0, 1, 1, tmp735, tmp235, tmp236,
          tmp237, tmp740);
#else
...
#ifdef USE_RHOMBUS
  // conv #53
  Conv2DWrapper_1m1Filter(7, 7, 512, 2048, 1, tmp753, tmp245, tmp755);
#else
...
#ifdef USE_RHOMBUS
  // matmul
  MatVecMul(1001, 2048, tmp250, tmp771, tmp773, 1);
#else
